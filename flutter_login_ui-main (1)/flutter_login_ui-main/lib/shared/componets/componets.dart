    ...
    tasks.length == 0
        ? Column(
            ...
            children: [
              ...
              Text(
                "$message",
                style: TextStyle(fontSize: 23, color: Color.fromARGB(255, 255, 255, 255)),
              ),
            ],
          )
        : ListView.separated(
...
_showBottomSheet(BuildContext context, Event event) {
  Get.bottomSheet(
    Container(
      ...
      color: Get.isDarkMode ? darkmodeColor :     Color.fromARGB(255, 227, 199, 234),
  ...
  return event.status == "new"
      ? Column(
          ...
          children: [
            defaultButton(
                text: 'Done',
                background: Color.fromARGB(224, 166, 0, 255),
                radius: 15,
                onpress: () {
            ...
            defaultButton(
                text: 'Archive',
                background: Color.fromARGB(189, 159, 71, 213),
                radius: 15,
                onpress: () {
                  todocontroller.updatestatusevent(
            ...
            defaultButton(
                text: 'Delete',
                background: Color.fromARGB(255, 112, 55, 143),
                radius: 15,
                onpress: () {
